  ...
  .setFields(
    {
      name: "No Refunds:",
      value:
        "By following the donation model, you agree that your money will not be refunded.\n" +
        "You can view the terms in more detail by visiting our website where the payments are made.",
    },
    {
      name: "Payment:",
      value:
        "Payments are made only through the server's site using the platform of your choice.\n" +
        "Paypal.\n" +
