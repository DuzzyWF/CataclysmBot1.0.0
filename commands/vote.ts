  ...
  callback: (message: Message) => {
    const voteEmbed = new MessageEmbed()
      ...
      .addFields({
        ...
        value:
          "Whenever you vote, enter your exact same nickname and wait for the site's confirmation before closing it",
      });

    message.delete(), message.channel.send({ embeds: [voteEmbed] });
  },
};
